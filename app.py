...
ORDER BY ASC(UCASE(str(?name)))
    ...
    # query = string.Template(query).substitute(COUNTY=location)

    # print(f'http://LAPTOP-45QEIGK2:7200/repositories/KDE-project?query={query}')
    # res = requests.request('GET', f'http://LAPTOP-45QEIGK2:7200/repositories/KDE-project?query={query}')
    # print(res.text)
    # counties = [res.text]  # Need to convert this string into an array of individual values
    # print(counties)
